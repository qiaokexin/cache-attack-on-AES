...
#define LINE ((NUMBER_OF_ENCRYPTIONS-1000)/100 + 1)
...
{ 
  ...
  //-------------------------collect samples for one key byte------------------------------
 
 //printf("Waiting for collecting ...\n");
for (size_t b=0; b < 1; ++b){// the b-th byte
 size_t ln = 0;
 //printf("b = %ld\n", b);
     ...
     if (delta < MIN_CACHE_MISS_CYCLES){
        ...
        if (((i + 1) >= 1000) && ((i + 1) % 100 == 0)){
           ...
           for (size_t byte = 0; byte < 256; ++byte)
              Ratio_patt[ln][byte] = (double)Ratio[byte] / (double) (i+1); 
